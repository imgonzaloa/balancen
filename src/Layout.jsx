...
const noNavPages = ["Onboarding", "Paywall", "CameraScreen", "MealResult", "LanguageSelector", "Premium", "ProfileSetup", "GroupDashboard", "ProgressPhotos"];
...
const NavButton = React.memo(function NavButton({ item, isActive, onNavigate, onScrollTop }) {
  ...
  return (
    ...
    >
      ...
      <span className={`text-xs mt-1 font-semibold whitespace-nowrap ${isActive ? "text-teal-300" : "text-slate-500"}`}>
        {item.label}
      </span>
    </button>
  );
