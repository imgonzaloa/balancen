    ...
    // Only load Stripe pricing on web
     if (!isNative) {
       base44.functions.invoke('getStripePublishableKey', {})
         ...
         .catch(() => setPricing({
           region: 'EUR', currency: '€',
           prices: { monthly: 8.99, yearly: 49.99, power_monthly: 12.99, power_yearly: 89.99 },
       ...
       setPricing({ region: 'EUR', currency: '€', prices: { monthly: 8.99, yearly: 49.99, power_monthly: 12.99, power_yearly: 89.99 }, priceIds: {} });
     }
