...
const resources = {
  en: {
    translation: {
      ...
      invite_friends: "Invite Friends",
      invite_subtitle: "Share Balancen and earn free Premium",
      invite_message_template: "Hi! I'm using Balancen to track my meals. Join me: {link}",
      copy_link: "Copy Link",
      copied: "Copied!",
      share: "Share",
      invites_sent: "Sent",
      referrals: "referrals",
      more_for_free_month: "more for 1 free month",
      invite_reward_note: "Every 3 friends who subscribe = 1 free month for you",
  ...
  es: {
    translation: {
      ...
      invite_friends: "Invitar Amigos",
      invite_subtitle: "Compartí Balancen y ganá Premium gratis",
      invite_message_template: "¡Hola! Estoy usando Balancen para trackear mis comidas. Unite: {link}",
      copy_link: "Copiar Link",
      copied: "¡Copiado!",
      share: "Compartir",
      invites_sent: "Enviadas",
      referrals: "referidos",
      more_for_free_month: "más para 1 mes gratis",
      invite_reward_note: "Cada 3 amigos que se suscriban = 1 mes gratis para vos",
